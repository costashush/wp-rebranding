...
add_action('login_enqueue_scripts', function () {
    ...
    if (!empty($settings['custom_login_logo'])) {
        $css .= "body.login h1 a{background-image:url('" . esc_url($settings['custom_login_logo']) . "') !important;background-size:cover !important;background-position:center center !important;background-repeat:no-repeat !important;width:300px !important;height:150px !important;}";
